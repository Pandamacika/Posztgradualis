...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println();
        DateTimeFormatter datum_formazasa = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss");
        String start_formazasa = start.format(datum_formazasa);
        String end_formazasa = end.format(datum_formazasa);
        System.out.println(start_formazasa);
        System.out.println(end_formazasa);
    }
